    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(blank=True, help_text='A number/id of the dataset that is used in goold-drive and other places.', null=True)),
                ('in_preparation', models.BooleanField(default=False, help_text='Dataset in preparation is just a template without data.')),
                ('env', models.FileField(blank=True, default='datasets/env/blank.xlsx', upload_to='datasets/env/', validators=[apps.datasets.validators.env_validator])),
                ('spp', models.FileField(blank=True, default='datasets/spp/blank.xlsx', upload_to='datasets/spp/', validators=[apps.datasets.validators.spp_validator])),
